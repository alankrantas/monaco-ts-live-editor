...
export const GenerateCompilerOptions = (strictMode: boolean, target: number) => {
    return {
        ...
        exactOptionalPropertyTypes: strictMode,
        checkJs: true,
        ...
        skipLibCheck: true,
        strict: strictMode,
        strictBindCallApply: strictMode,
        strictBuiltinIteratorReturn: strictMode,
        strictFunctionTypes: strictMode,
        strictNullChecks: strictMode,
        strictPropertyInitialization: strictMode,
        target: target,
        noEmit: true,
    }
};